...
a regularly refreshed dataset containing sparse in-situ oceanographic observations that are
...
oceanography and to be accessed by the wider oceanographic
community.
...
At this time CrocoLakeTools is released with converters for data from Argo [@wong2020argo], GLODAP (Global Ocean Data Analysis Project, @key2015global, @lauvset2016new, @olsen2016global) and Spray Data (@sherman2002autonomous, @rudnick2004underwater, @rudnick2011sampling, @gopalakrishnan2013state, @johnston2013internal, @rudnick2013high, @rudnick2015cyclonic, @schonau2015glider, @rudnick2016ocean, @rudnick2016spray, @todd2016potential, @centurioni2017northern, @schonau2017mindanao, @zeiden2019glider, @heiderich2020along). The choice of glider data is limited to Spray Data because they are provided in delayed mode (i.e. with comprehensive and manual quality-control): we are interested in including data from the wider IOOS gliders network in the future, yet to our knowledge quality-control processes for delayed mode data are not yet standardized across all the network. We are also working towards adding new datasets, such as observations collected by Saildrones used by the Ocean Climate Stations Project (NOAA) and expendable bathythermograph data collected by the Oleander Project.
...
`CrocoLakeTools` is used to build CrocoLake, a fast and cloud-optimized dataset of oceanographic observations, making diverse observations accessible faster and more efficiently as we show in the following.
...
|-----------|---------------------|---------------------------------------------------|---------------------:|--------------------:|
| PHY   | Large         | Lat: [25,60], Lon: [-80,-30], Date: 2017-01-01 to 2018-01-01 | 44.8 ± 0.4 s        | 1266 ± 8.6s        |
| PHY   | Small         | Lat: [55,60], Lon: [-50,-55], Date: 2017-01-01 to 2018-01-01 | 19.5 ± 1.5 s        | 63 ± 1.9s         |
| BGC   | Large         | Lat: [25,60], Lon: [-80,-30], Date: 2017-01-01 to 2018-01-01 | 8.5 ± 0.7 s        | 954 ± 1.1s       |
| BGC   | Small         | Lat: [55,60], Lon: [-50,-55], Date: 2017-01-01 to 2018-01-01 | 5.0 ± 2.3 s        | 108 ± 4.3s        |
...
We acknowledge the Argo, Spray Data, and GLODAP programs for their efforts in collecting ocean observations and making them publicly available. The Argo data are collected and made freely available by the International Argo Program and the national programs that contribute to it (https://argo.ucsd.edu,  https://www.ocean-ops.org), and is part of the Global Ocean Observing System. E.M. thanks Robert Todd for guidance in accessing Spray Data. 
